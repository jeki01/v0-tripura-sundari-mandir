    ...
    <section className="py-6 bg-gradient-to-b from-[#FFF4E6] to-[#FDF0D5]">
      <div className="container mx-auto px-3">
        ...
        <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-9 gap-2 md:gap-3 mb-6">
          {quickLinks.map((link, index) => {
            ...
            return (
              <Card
                key={index}
                className={`group cursor-pointer border hover:shadow-md transition-all duration-200 bg-white overflow-hidden touch-manipulation relative ${
                  link.highlighted
              ...
              >
                <CardContent className="p-2 text-center">
                  ...
                  <div className="mb-1">
                    <div
                      className={`w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-br ${link.color} rounded-full flex items-center justify-center mx-auto group-hover:scale-105 transition-transform duration-200 ${
                        link.highlighted ? "shadow-lg animate-bounce" : ""
                      }`}
                    >
                  ...
                  <div className="space-y-0">
                    <h4
                      className={`font-bold text-xs leading-tight ${
                        link.highlighted ? "text-[#FF6B00] animate-pulse" : "text-[#B30000]"
                      }`}
                    >
                      {link.title}
                    </h4>
        ...
        <div className="text-center">
          <div className="bg-gradient-to-r from-[#FFF4E6] to-[#FFD700]/20 p-3 rounded-lg border-2 border-[#FFD700] inline-block">
            <div className="flex items-center justify-center mb-2">
              <Crown className="text-[#FFD700] mr-1" size={16} />
              <h3 className="text-lg font-bold text-[#B30000]">माँ त्रिपुरा सुंदरी</h3>
              <Crown className="text-[#FFD700] ml-1" size={16} />
            </div>
            <div className="flex flex-wrap gap-2 justify-center">
              <Button
                size="sm"
                className="bg-gradient-to-r from-[#B30000] to-[#FF6B00] hover:from-[#FF6B00] hover:to-[#B30000] text-white font-bold px-4 py-2 text-xs shadow-md hover:shadow-lg transition-all duration-200 touch-manipulation"
                onClick={() => handleLinkClick("#darshan-live")}
              >
              ...
              <Button
                size="sm"
                className="bg-gradient-to-r from-[#FF6B00] to-[#FFD700] hover:from-[#FFD700] hover:to-[#FF6B00] text-[#B30000] font-bold px-4 py-2 text-xs shadow-md hover:shadow-lg transition-all duration-200 touch-manipulation"
                onClick={() => handleLinkClick("#pujas")}
              >
              ...
              <Button
                size="sm"
                variant="outline"
                className="border border-[#FF6B00] text-[#FF6B00] hover:bg-[#FF6B00] hover:text-white font-bold px-4 py-2 text-xs transition-all duration-200 touch-manipulation animate-pulse"
                onClick={() => handleLinkClick("https://matrimony.shreetripurasundari.com/", true)}
              >
