...
import { Crown, Calendar, Phone, Mail, ExternalLink, Sparkles, Heart, Clock } from "lucide-react"
...
export default function ShringarScheduleSection() {
  ...
  return (
    <section className="py-16 bg-gradient-to-b from-[#FFF4E6] to-[#FDF0D5]">
      <div className="container mx-auto px-4">
        {/* Section Header */}
        <div className="text-center mb-12">
          <div className="flex items-center justify-center mb-6">
            <Crown className="text-[#B30000] mr-3" size={32} />
            <h2 className="text-4xl font-bold text-[#B30000]">माँ श्री त्रिपुरा की श्रृंगार समय सारणी</h2>
          </div>
          <p className="text-[#FF6B00] text-xl">Weekly Divine Decoration Schedule</p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <Card className="border-4 border-[#FFD700] shadow-2xl mb-12">
            <CardHeader className="bg-gradient-to-r from-[#FFD700] to-[#FF6B00] text-[#B30000] text-center">
              ...
              <p className="text-[#B30000]/80 mt-2">Weekly Color Scheme for Divine Decoration</p>
            </CardHeader>
              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead className="bg-[#FDF0D5]">
                    <tr>
                      <th className="text-left p-4 font-bold text-[#B30000] border-b border-[#FF6B00]/30">क्रमांक</th>
                      <th className="text-left p-4 font-bold text-[#B30000] border-b border-[#FF6B00]/30">वार</th>
                      ...
                      >
                        ...
                        <td className="p-4 font-medium text-[#B30000] border-b border-[#FF6B00]/20">
                          <div>
                            ...
                            <div className="text-sm text-gray-600">{item.dayEng}</div>
                          </div>
                        </td>
                        <td className="p-4 border-b border-[#FF6B00]/20">
                          <div className="flex items-center">
                            ...
                            ></div>
                            <div>
                              <div className="font-bold text-[#B30000]">{item.color}</div>
                              <div className="text-sm text-gray-600">{item.colorEng}</div>
                            </div>
                          </div>
                        </td>
          ...
          <Card className="border-4 border-[#B30000] shadow-2xl mb-12">
          ...
          {/* Special Notes */}
          <Card className="border-4 border-[#FFD700] shadow-2xl mb-12 bg-gradient-to-br from-[#FFF4E6] to-[#FFD700]/10">
            ...
            <CardContent className="p-6">
              <div className="bg-[#FDF0D5] p-6 rounded-lg border-2 border-[#FF6B00] mb-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      ...
                      श्रृंगार केवल
                      <strong className="text-[#B30000]"> मंदिर ट्रस्ट द्वारा</strong> किया जाता है। इन विशेष दिनों में व्यक्तिगत
                      श्रृंगार बुकिंग उपलब्ध नहीं है।
                    </p>
                  </div>
                </div>
              </div>
            ...
            <CardContent className="p-8">
              <div className="text-center mb-8">
                <p className="text-gray-700 text-lg leading-relaxed mb-6">
                  यदि आप माँ श्री त्रिपुरा के श्रृंगार हेतु बुकिंग करना चाहते हैं, तो नीचे दिए गए विकल्पों का उपयोग करें अथवा मंदिर ट्रस्ट से
                  सीधे संपर्क करें:
                </p>
              </div>
              ...
              <div className="mt-8 bg-[#FFF4E6] p-6 rounded-lg border-2 border-[#FFD700]">
                <h4 className="font-bold text-[#B30000] mb-3 text-center">श्रृंगार बुकिंग की जानकारी:</h4>
                <div className="grid md:grid-cols-3 gap-4 text-sm text-gray-700">
                  <div className="text-center">
                    <div className="font-bold text-[#B30000] mb-1">बुकिंग समय:</div>
                    <p>सुबह 9:00 बजे से शाम 6:00 बजे तक</p>
                  </div>
                  <div className="text-center">
                    <div className="font-bold text-[#B30000] mb-1">अग्रिम बुकिंग:</div>
                    <p>कम से कम 3 दिन पहले बुक करें</p>
                  </div>
                  <div className="text-center">
                    <div className="font-bold text-[#B30000] mb-1">श्रृंगार समय:</div>
                    <p>प्रातः 5:00 बजे से 6:00 बजे तक</p>
                  </div>
                </div>
              </div>
            </CardContent>
